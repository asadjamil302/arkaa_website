            ...
            <div class="col-lg-8 col-12">
                <div class="block  block-themed">
                    <div class="block-header bg-gd-aqua">
                        <h3 class="block-title">Testimonial Create</h3>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('designation')) is-invalid @endif"  required name="designation" placeholder="Enter designation" value="{{old('designation')}}">
