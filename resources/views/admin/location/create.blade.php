            ...
            <div class="col-lg-8 col-12">
                <div class="block  block-themed">
                    <div class="block-header bg-gd-aqua">
                        <h3 class="block-title">Location Create</h3>
                    </div>
                    <div class="block-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    <label class="col-lg-12" for="city">City Name</label>
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('city')) is-invalid @endif"  required name="city" placeholder="Enter city" value="{{old('city')}}">
                                        @if($errors->has('city'))
