            ...
            <div class="col-lg-8 col-12">
                <div class="block  block-themed">
                    <div class="block-header bg-gd-aqua">
                        <h3 class="block-title">Slider Edit</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('title')) is-invalid @endif"  required name="title"  value="{{$slider->title}}">
                                        @if($errors->has('title'))
                            ...
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('price')) is-invalid @endif"  required name="price"  value="{{$slider->price}}">
                                        @if($errors->has('price'))
                                        <span class="invalid-feedback" role="alert">
            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="block block-themed">
                    ...
                    <div class="block-content block-content-full text-center">
                        <img class="img-avatar img-avatar-thumb" src="{{$slider->image}}" alt="">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="file" class="form-control form-control-lg @if($errors->has('image')) is-invalid @endif" name="image" {{$slider->image}}>
                                        @if($errors->has('image'))
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="js-tags-input form-control form-control-lg @if($errors->has('meta_tag')) is-invalid @endif" data-height="34px" id="example-tags1" name="meta_tag" value="{{$slider->meta_tag}}">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('meta_title')) is-invalid @endif"  required name="meta_title"  value="{{$slider->meta_title}}">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('meta_description')) is-invalid @endif"  required name="meta_description" value="{{$slider->meta_description}}">
