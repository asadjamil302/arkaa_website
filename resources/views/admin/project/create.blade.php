                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control form-control-lg @if($errors->has('title')) is-invalid @endif"  required name="title" placeholder="Enter The City Name" value="{{old('title')}}">
                                        @if($errors->has('title'))
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="file" class="form-control form-control-lg @if($errors->has('image')) is-invalid @endif"  required name="image" >
                                        @if($errors->has('image'))
                                        <span class="invalid-feedback" role="alert">
